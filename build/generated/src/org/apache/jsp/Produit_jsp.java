...
public final class Produit_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        var ref = document.getElementsByName(\"reference\")[0].value;\n");
      ...
      out.write("            window.location.href=\"CategorieController?op=update&id=\"+ id; \n");
      out.write("            \n");
      ...
      out.write("    \n");
      out.write("\n");
      out.write("    function updateProduit(id, ref, prix, categorie) {\n");
      ...
      out.write("    }\n");
      out.write("    \n");
      out.write("    // Function to handle select change event\n");
      out.write("    document.getElementById('categorieSelect').addEventListener('change', function () {\n");
      out.write("        var selectedOption = this.options[this.selectedIndex];\n");
      out.write("        if (selectedOption.value !== \"\") {\n");
      out.write("            // You can access the selected option's value and text like this:\n");
      out.write("            var selectedValue = selectedOption.value;\n");
      out.write("            var selectedText = selectedOption.textContent;\n");
      out.write("            \n");
      out.write("            // Do something with the selected values if needed\n");
      out.write("            console.log('Selected Value:', selectedValue);\n");
      out.write("            console.log('Selected Text:', selectedText);\n");
      out.write("        }\n");
      out.write("    });\n");
      out.write("</script>\n");
      out.write("        <form action=\"ProduitController\" onsubmit=\"return validateForm()\" id=\"produitForm\" >\n");
      out.write("            <fieldset>\n");
      ...
      out.write("                    <tr>\n");
      out.write("                        \n");
      out.write("                        <td><input type=\"submit\" value=\"ajouter\" name=\"valider\" onclick=\"captureSelectedValue()\" />\n");
      out.write("</td>\n");
      out.write("                        \n");
      out.write("                        <td></td>\n");
      out.write("                    </tr>\n");
      ...
      out.print(p.getId());
      out.write("\"><button>Supprimer</button></a></td>\n");
